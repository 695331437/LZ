...
- (CYLTabBarController *)tabBarController {
    if (_tabBarController == nil) {
        LZHomeController *firstViewController = [[LZHomeController alloc] init];
        UIViewController *firstNavigationController = [[LZRootNavigationController alloc]
                                                       initWithRootViewController:firstViewController];
        
        LZEditController *secondViewController = [[LZEditController alloc] init];
